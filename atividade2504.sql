...
INSERT INTO vendas (id_venda, nome_cliente, item_pedido, quantidade, valor)
VALUES
...
CREATE USER 'sistemaselect'@'localhost' IDENTIFIED BY 'user7777';
GRANT SELECT ON db_escola. * TO 'sistemaselect'@'localhost';

-- Realize a remoção da permissão SELECT do usuário sistema
